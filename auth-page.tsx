    ...
    <div className="flex min-h-screen flex-col bg-[#f8ecec]">
      <div className="flex justify-end p-3">
        <a
          ...
          className="text-[#2D1357] text-base font-medium hover:underline flex items-center"
        >
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4">
        <div className="w-full max-w-md space-y-4">
          <div className="space-y-1 text-center">
            <h1
              className="text-3xl font-bold text-[#2D1357]"
              style={{
                textShadow: "1px 1px 2px rgba(0,0,0,0.1)",
                WebkitTextStroke: "0.5px #2D1357",
          ...
          <div className="text-center">
            <button
              ...
              className="text-base text-[#2D1357] font-medium hover:underline"
            >
